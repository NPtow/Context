...
# Emerging idea: company-specific interview database

Никита зафиксировал новую рабочую идею: многие компании уже записывают интервью с кандидатами, которые проходят через их hiring funnel. Если компания готова легально дать доступ к таким записям и связанным outcome-данным, JJFR потенциально может строить под каждую компанию отдельную базу hiring evidence.

Возможная структура такой базы:
- интервью-записи и расшифровки;
- роль, на которую шёл кандидат;
- вопросы и probing patterns интервьюера;
- выявленные навыки, сигналы и риски;
- решение по кандидату и причина решения, если доступна;
- company-specific критерии "проходит / не проходит";
- повторяющиеся паттерны hiring manager'ов и команд.

Почему это может быть важно для текущей механики:
- усиливает идею `матрица роли × матрица кандидата`: матрица роли может строиться не только из brief'а, но и из исторических интервью компании;
- помогает кодировать реальный hiring bar компании, а не только публичное описание вакансии;
- создаёт employer-side data asset, который может улучшать future shortlist, candidate evidence pack и объяснение релевантности.

Границы и риски:
- это не текущий обязательный слой пилота, а отдельная гипотеза для проверки;
- нельзя предполагать использование интервью-записей без согласия, прав на обработку персональных данных и понятного data retention режима;
- ценность зависит от того, есть ли у работодателя записи, расшифровки, outcome labels и готовность делиться ими;
- нужно проверить, не воспринимается ли это работодателем как слишком тяжёлый enterprise/onboarding продукт для первой сделки.

Что проверить:
- какие компании действительно записывают candidate interviews и где хранят эти записи;
- готовы ли HR / HM дать доступ к записям или хотя бы к обезличенным transcript snippets;
- есть ли outcome labels: прошёл дальше, отказ, нанят, причина отказа;
- можно ли из 10-20 прошлых интервью собрать полезную company-specific role/hiring matrix;
- повышает ли такой слой доверие работодателя к shortlist сильнее, чем обычный role brief.
